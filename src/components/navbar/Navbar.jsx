...
const Navbar = () => {
  ...
  const menuItemsNotLoggedIn = [
    ...
    },
    {
      ...
      path: "/about",
      submenu: [{ label: "A propos", path: "/about" },{ label: "Mentions légales", path: "/privacy" }],
    },
    {
      label: "Aide",
      icon: <HelpCircle className="w-4 h-4" />,
      path: "/help",
      submenu: [{ label: "Comment ça marche ?", path: "/help" },{ label: "Programme de parrainage", path: "/referral" }],
    },
  ];
  ...
  const renderMobileMenu = () => {
    const mobileMenuItems = isUserLoggedIn
        ? menuItemsLoggedIn
          ...
          <div className="max-w-7xl mx-auto px-4 h-full">
            <div className="flex items-center justify-between h-full">
              ...
              <div className="hidden xl:flex items-center justify-end flex-1">
                {renderMenuItems(isUserLoggedIn ? menuItemsLoggedIn : menuItemsNotLoggedIn)}
                {renderAuthButtons()}
              </div>
